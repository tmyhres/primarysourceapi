...
@RestController
@RequestMapping("/api/primarysourceapi-kafka")
public class PrimarysourceapiKafkaResource {
    private final Logger log = LoggerFactory.getLogger(PrimarysourceapiKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PrimarysourceapiKafkaResource(KafkaProperties kafkaProperties) {
